...
public class MaterialDialog extends AbstractDialog {
    ...
    /**
     * Builder for {@link com.shreyaspatil.MaterialDialog.MaterialDialog}.
     */
    public static class Builder {
        ...
        /**
         * Build the {@link com.shreyaspatil.MaterialDialog.MaterialDialog}.
         */
        @NonNull
        public com.madhav.maheshwari.customdialog.MaterialDialog build() {
            return new com.madhav.maheshwari.customdialog.MaterialDialog(activity, title, message, isCancelable, positiveButton, negativeButton, animationResId, animationFile);
        }
    }
}
