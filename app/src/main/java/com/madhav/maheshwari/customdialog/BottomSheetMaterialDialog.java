 ...
 * <p>
 * Use {@link com.shreyaspatil.MaterialDialog.BottomSheetMaterialDialog.Builder} to create a new instance.
 */
public class BottomSheetMaterialDialog extends AbstractDialog {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            dialogView.setOutlineProvider(new ViewOutlineProvider() {
                ...
                public void getOutline(View view, Outline outline) {
                    float radius = mActivity.getResources().getDimension(com.shreyaspatil.MaterialDialog.R.dimen.radiusTop);
                    outline.setRoundRect(0, 0, view.getWidth(), view.getHeight() + (int) radius, radius);
                }
            });
            dialogView.setClipToOutline(true);
        } else {
            dialogView.findViewById(com.shreyaspatil.MaterialDialog.R.id.relative_layout_dialog).setPadding(0, (int) mActivity.getResources().getDimension(com.shreyaspatil.MaterialDialog.R.dimen.paddingTop), 0, 0);
        }
    ...
    /**
     * Builder for {@link com.shreyaspatil.MaterialDialog.BottomSheetMaterialDialog}.
     */
    public static class Builder {
        ...
        /**
         * Build the {@link com.shreyaspatil.MaterialDialog.BottomSheetMaterialDialog}.
         */
        @NonNull
        public com.madhav.maheshwari.customdialog.BottomSheetMaterialDialog build() {
            return new com.madhav.maheshwari.customdialog.BottomSheetMaterialDialog(activity, title, message, isCancelable, positiveButton, negativeButton, animationResId, animationFile);
        }
    }
    ...
    class BottomSheetDialog extends com.google.android.material.bottomsheet.BottomSheetDialog {
        ...
        BottomSheetDialog(@NonNull Context context) {
            super(context, com.shreyaspatil.MaterialDialog.R.style.BottomSheetDialogTheme);
        }
    }
}
