...
public class AbstractDialog implements DialogInterface {
    ...
    protected View createView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        ...
        final View dialogView = inflater.inflate(com.shreyaspatil.MaterialDialog.R.layout.layout_alert_dialog, container, false);

        // Initialize Views
        TextView mTitleView = dialogView.findViewById(com.shreyaspatil.MaterialDialog.R.id.textView_title);
        TextView mMessageView = dialogView.findViewById(com.shreyaspatil.MaterialDialog.R.id.textView_message);
        MaterialButton mPositiveButtonView = dialogView.findViewById(com.shreyaspatil.MaterialDialog.R.id.button_positive);
        MaterialButton mNegativeButtonView = dialogView.findViewById(com.shreyaspatil.MaterialDialog.R.id.button_negative);
        mAnimationView = dialogView.findViewById(com.shreyaspatil.MaterialDialog.R.id.animation_view);
        ...
        if (mPositiveButton != null) {
            ...
            mPositiveButtonView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    mPositiveButton.getOnClickListener().onClick(com.madhav.maheshwari.customdialog.AbstractDialog.this, BUTTON_POSITIVE);
                }
            });
        } else {
        ...
        if (mNegativeButton != null) {
            ...
            mNegativeButtonView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    mNegativeButton.getOnClickListener().onClick(com.madhav.maheshwari.customdialog.AbstractDialog.this, BUTTON_NEGATIVE);
                }
            });
        } else {
        ...
        // Apply Styles
        TypedArray a = mActivity.getTheme().obtainStyledAttributes(com.shreyaspatil.MaterialDialog.R.styleable.MaterialDialog);

        try {
            // Set Dialog Background
            dialogView.setBackgroundColor(
                    a.getColor(com.shreyaspatil.MaterialDialog.R.styleable.MaterialDialog_material_dialog_background,
                            mActivity.getResources().getColor(com.shreyaspatil.MaterialDialog.R.color.material_dialog_background)));

            // Set Title Text Color
            mTitleView.setTextColor(
                    a.getColor(com.shreyaspatil.MaterialDialog.R.styleable.MaterialDialog_material_dialog_title_text_color,
                            mActivity.getResources().getColor(com.shreyaspatil.MaterialDialog.R.color.material_dialog_title_text_color)));

            // Set Message Text Color
            mMessageView.setTextColor(
                    a.getColor(com.shreyaspatil.MaterialDialog.R.styleable.MaterialDialog_material_dialog_message_text_color,
                            mActivity.getResources().getColor((com.shreyaspatil.MaterialDialog.R.color.material_dialog_message_text_color))));

            // Set Positive Button Icon Tint
            ColorStateList mPositiveButtonTint = a.getColorStateList(
                    com.shreyaspatil.MaterialDialog.R.styleable.MaterialDialog_material_dialog_positive_button_text_color);

            if (mPositiveButtonTint == null) {
                mPositiveButtonTint = ContextCompat.getColorStateList(
                        mActivity.getApplicationContext(),
                        com.shreyaspatil.MaterialDialog.R.color.material_dialog_positive_button_text_color);
            }
            ...
            ColorStateList mNegativeButtonTint = a.getColorStateList(
                    com.shreyaspatil.MaterialDialog.R.styleable.MaterialDialog_material_dialog_negative_button_text_color);

            if (mNegativeButtonTint == null) {
                mNegativeButtonTint = ContextCompat.getColorStateList(
                        mActivity.getApplicationContext(),
                        com.shreyaspatil.MaterialDialog.R.color.material_dialog_negative_button_text_color);
            }
            ...
            ColorStateList mBackgroundTint = a.getColorStateList(
                    com.shreyaspatil.MaterialDialog.R.styleable.MaterialDialog_material_dialog_positive_button_color);

            if (mBackgroundTint == null) {
                mBackgroundTint = ContextCompat.getColorStateList(
                        mActivity.getApplicationContext(),
                        com.shreyaspatil.MaterialDialog.R.color.material_dialog_positive_button_color);
            }
